...
def multiprocessingCalibration(camera_selection, SIZE):
    global global_image, STOP_ALL_PROCESSES, K, extended_K, dist, calib_R_t_with_0001

    while not STOP_ALL_PROCESSES:
        global_image, K, extended_K, dist, calib_R_t_with_0001 = ImageHandler.getCalibrationMatrices(camera_selection, SIZE)
